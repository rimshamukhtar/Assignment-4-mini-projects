...
def main():
    user_input = input(PROMPT).strip().lower()  # User se input lena aur clean karna
    
    if "joke" in user_input:  # Agar input mein "joke" ho toh
        print(JOKE)  # Joke print karo
    else:
        print(SORRY)  # Agar koi aur input ho toh sorry message dikhana
